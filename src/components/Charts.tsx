...
function ChartCard({ title, children, className = '' }: { title: string; children: React.ReactNode; className?: string }) {
  return (
    <div className={`bg-[#111827] rounded-2xl border border-[#1E2D45] p-6 shadow-sm hover:shadow-md transition-shadow duration-300 ${className}`}>
      <h3 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wider mb-4 text-center">{title}</h3>
      {children}
    </div>
  );
}
        ...
        <div className="relative h-80 w-full">
          <Bar
            ...
            options={{
              ...
              maintainAspectRatio: false,
              scales: {
                x: { grid: { color: '#1E2D45' }, ticks: { font: { size: 11 } } },
        ...
        <div className="relative h-80 w-full">
          <Bar
            ...
            options={{
              ...
              maintainAspectRatio: false,
              scales: {
                y: { beginAtZero: true, grid: { color: '#1E2D45' }, ticks: { font: { size: 11 } } },
